...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.945.693 2.166 1.638m-7.332 0c.055.194.084.4.084.612v0a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 011.927-.184" />
      </svg>
    ),
  },
  {
...
export default function Navbar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-zinc-800/80 bg-zinc-950">
      <div className="flex h-16 items-center gap-3 border-b border-zinc-800/80 px-6">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-600 shadow-lg shadow-violet-600/25">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-500">캠페인 관리 대시보드</p>
        </div>
      </div>
      ...
      <div className="border-t border-zinc-800/80 p-4">
        <div className="rounded-lg bg-zinc-900/80 px-3 py-3 ring-1 ring-zinc-800">
          <p className="text-xs font-medium text-zinc-400">MVP 버전</p>
          <p className="mt-0.5 text-xs text-zinc-500">Mock 데이터 기반</p>
        </div>
      </div>
    </aside>
  );
